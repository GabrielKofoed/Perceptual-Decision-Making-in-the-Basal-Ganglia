"""
Testing the model across different input strengths, with and without cortex. 
"""
...
save_results(results, 'suite2', 'data/cortical dynamics')
save_results(results_bypass, 'suite2_bypass', 'data/cortical dynamics')
