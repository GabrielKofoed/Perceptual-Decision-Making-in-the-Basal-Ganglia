...
Running the model across different levels of strength.
"""
...
# Parameters combinations to test. Testing for both different strength levels and levels of coherence
varying_params = {
    'coherence': [1, 0.3, 0.15, 0.1, 0.08, 0.05, 0.03, 0.01],
    'strength': [0.8, 0.6, 0.4]
}
...
save_results(results_m10, 'suite4_m10', 'data/learning')
save_results(results_10, 'suite4_10', 'data/learning')
save_results(results_20, 'suite4_20', 'data/learning')